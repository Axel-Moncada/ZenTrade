...
const translations = {
  ...
  en: {
    ...
    landing: {
      ...
      heroDescriptor: 'The AI trading journal built to pass prop firm evaluations. 14-day free trial.',
      ...
      heroStat1Value: '14 days',
      heroStat1Label: 'Free trial, no card',
      heroStat2Value: '5',
      heroStat2Label: 'Prop firms supported',
      // problem section
