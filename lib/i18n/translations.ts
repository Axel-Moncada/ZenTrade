...
const translations = {
  es: {
    ...
    profile: {
      ...
      planMaxCtaLabel: 'Actualizar a ZenMode',
    ...
    landing: {
      ...
      heroDescriptor: 'El journal de trading con IA para pasar evaluaciones de fondeo. 14 días gratis.',
      ...
      heroStat1Value: '14 días',
      heroStat1Label: 'Prueba gratuita completa',
      heroStat2Value: '5',
      heroStat2Label: 'Prop firms soportadas',
      heroCtaMicrocopy: 'Sin tarjeta — prueba completa 14 días, cancela cuando quieras',
      heroMiniTestimonial: '"Pasé Apex Phase 1 después de 2 intentos fallidos. El reporte semanal de IA me mostró que hacía revenge trading cada martes. Lo corregí en 10 días."',
      heroMiniTestimonialAuthor: '— Marcus T., Trader NQ',
      // ai features section
      aiSectionBadge: 'Powered by Gemini 2.5 · IA Integrada',
      aiSectionTitle1: 'La IA que Opera',
      aiSectionTitle2: 'A Tu Lado',
      aiSectionSubtitle: 'ZenTrade no solo registra tus trades. Lee tus patrones — emocionales, conductuales, por horario — y te dice lo que tu P&L no puede decirte solo.',
      aiSectionCta: 'Los Reportes Semanales están incluidos en Professional. El stack completo de IA — en ZenMode.',
      aiSectionCtaButton: 'Ver planes ZenMode',
      aiFeatures: [
        {
          badge: 'ZenMode · Professional',
          title: 'Tu Briefing Semanal con IA',
          description: 'Cada lunes por la mañana, Gemini analiza tu semana anterior: horas de mayor rendimiento, estados emocionales ligados a pérdidas, qué tan cerca estuviste de violar reglas del fondo, y una corrección específica para la semana que viene. No un resumen genérico — un informe escrito para tus trades, no una plantilla.',
          icon: 'report',
          highlight: false,
        },
        {
          badge: 'Exclusivo ZenMode',
          title: 'Radar de Mercado del Domingo',
          description: 'Cada domingo por la noche, la IA de ZenTrade escanea noticias globales con Google Search y entrega 6–9 eventos de alto impacto para la semana siguiente — IPC, FOMC, earnings, riesgos geopolíticos — cada uno mapeado a tus instrumentos. NQ, ES, CL, GC. Abres el lunes sabiendo qué vigilar. Ningún otro journal hace esto.',
          icon: 'radar',
          highlight: true,
        },
        {
          badge: 'ZenMode',
          title: 'Guardia Anti-Revenge Trading',
          description: 'Tomaste una pérdida. Diez minutos después volviste al mercado — tamaño mayor, sin setup, solo adrenalina. ZenTrade marca cada trade que entras dentro de los 30 minutos de una pérdida y detecta rachas de pérdidas consecutivas antes de que vuelen tu evaluación. Una alerta por sesión puede ser la diferencia entre pasar y reiniciar.',
          icon: 'guard',
          highlight: false,
        },
      ],
      ...
      pricingTiers: [
        {
          ...
          description: 'Revenge Trading IA · Reporte Semanal · Radar de Mercado — el stack completo de IA para traders serios',
          badge: 'Stack Completo de IA',
          comingSoon: false,
          features: ['Todo en Professional +', 'Detección de revenge trading en tiempo real (IA)', 'Alertas de reglas de riesgo (daily loss, position size)', 'Reporte semanal automático con análisis emocional (IA)', 'Radar de mercado dominical — 6–9 eventos de alto impacto (IA)', 'Benchmark vs. requisitos de empresa de fondeo', 'Coaching 1-a-1 mensual (30 min)', 'Soporte dedicado 24/7'],
  ...
  en: {
    ...
    landing: {
      ...
      // hero
      heroBadge: 'The Only Futures Journal That Thinks With You',
      heroHeadline1: 'Your AI Coach.',
      heroHeadline2: 'Your Prop Firm Edge.',
      heroDescriptor: "ZenTrade's AI watches your patterns, flags revenge trading in real time, and sends you a weekly performance breakdown — so the next evaluation is the last one you need.",
      heroSubPrefix: 'Most traders who fail prop firm evaluations aren\'t bad at trading. They\'re making the same 2–3 mistakes on repeat, and they have no system that shows them which ones. ',
      heroSubHighlight: 'ZenTrade is that system',
      heroSubSuffix: ' — AI-powered, built for futures, free to start.',
      heroProof1: 'Revenge Trading AI Detection',
      heroProof2: 'Weekly AI Performance Report',
      heroProof3: 'Market Radar — Every Sunday',
      heroProof4: 'FTMO · Apex · TopStep · Uprofit · Tradoverse',
      heroSeePlans: 'See Plans',
      heroStat1Value: '3',
      heroStat1Label: 'AI-powered analysis tools',
      heroStat2Value: '$0',
      heroStat2Label: 'To start — no card required',
      heroCtaMicrocopy: 'No card required — full 14-day trial, cancel anytime',
      heroMiniTestimonial: '"Passed Apex Phase 1 after 2 failed attempts. The weekly AI report showed me I was revenge trading every Tuesday. Fixed it in 10 days."',
      heroMiniTestimonialAuthor: '— Marcus T., NQ Trader',
      // ai features section
      aiSectionBadge: 'AI-Powered · Built on Gemini 2.5',
      aiSectionTitle1: 'The AI That Trades',
      aiSectionTitle2: 'Alongside You',
      aiSectionSubtitle: "ZenTrade doesn't just log your trades. It reads your patterns — emotional, behavioral, time-based — and tells you what your P&L can't tell you on its own.",
      aiSectionCta: 'Weekly Reports are included in Professional. The full AI stack — in ZenMode.',
      aiSectionCtaButton: 'See ZenMode Plans',
      aiFeatures: [
        {
          badge: 'ZenMode · Professional',
          title: 'Your Monday Edge Brief',
          description: 'Every Monday morning, Gemini analyzes your previous week: peak performance hours, emotional states tied to losses, how close you were to breaching prop firm rules, and one specific fix for the coming week. Not a generic summary — a pre-market briefing written for your trades, not a template.',
          icon: 'report',
          highlight: false,
        },
        {
          badge: 'ZenMode Exclusive',
          title: 'Sunday Market Radar',
          description: 'Every Sunday evening, ZenTrade\'s AI scans global news using Google Search and delivers 6–9 high-impact events for the coming week — CPI, FOMC, earnings, geopolitical risks — each mapped to your instruments. NQ, ES, CL, GC. You open Monday knowing what to watch. No other trading journal does this.',
          icon: 'radar',
          highlight: true,
        },
        {
          badge: 'ZenMode',
          title: 'AI Revenge Guard',
          description: 'You took a loss. Ten minutes later you were back in the market — bigger size, no setup, just adrenaline. ZenTrade flags every trade entered within 30 minutes of a loss and surfaces consecutive losing streaks before they become a blown evaluation. One alert per session can be the difference between passing and resetting.',
          icon: 'guard',
          highlight: false,
        },
      ],
      ...
      // benefits section
      benefitsTitle1: 'Stop Guessing Why',
      benefitsTitle2: 'You Keep Losing Evaluations',
      benefitsSubtitle: "The gap between traders who pass evaluations and traders who keep paying for them isn't strategy — it's visibility. ZenTrade gives you AI-level visibility into your own behavior. Revenge trading, bad hours, broken rules, emotional patterns. Visible. Actionable. Fixed.",
      benefitsList: [
        { title: 'AI Catches Revenge Trades', description: 'The AI flags entries made within 30 minutes of a loss, or after 3+ consecutive losers. One real-time alert can save a $150 reset fee and a month of work.' },
        { title: 'Know Your Actual Edge', description: 'Your dashboard shows PnL by hour, instrument, and session. Most traders discover they have one profitable 2-hour window — and they\'ve been losing money outside of it.' },
        { title: 'Every Account. One Dashboard.', description: 'Evaluation accounts (FTMO, Apex, TopStep), funded accounts, and live accounts — tracked separately, seen together. Consistency rules per account, not combined.' },
        { title: 'Prop Firm-Ready Documentation', description: 'Consistency score, equity curve, max drawdown — visible in real time, exportable as PDF. The exact evidence prop firms look for, organized before they ask.' },
      ],
      benefitsReview1: '"ZenTrade showed me I was losing 73% of my Friday afternoon trades. I had no idea — I thought Fridays were fine. I stopped trading after 2PM on Fridays. Two weeks later, my monthly P&L flipped positive."',
      benefitsReview1Author: 'Alejandro M.',
      benefitsReview1Role: 'Futures Day Trader — NQ/MNQ',
      benefitsReview2: '"Failed TopStep Phase 2 twice for consistency. ZenTrade let me see exactly which trades were breaking the rule — always the first 20 minutes of the session. Third attempt, I passed with 8% of the consistency buffer left."',
      benefitsReview2Author: 'Laura R.',
      benefitsReview2Role: 'Futures Trader — TopStep funded',
      // pricing section
      ...
      pricingTiers: [
        {
          ...
          description: 'Revenge Trading AI · Weekly Performance Report · Sunday Market Radar — the full AI stack for serious evaluation traders',
          badge: 'Full AI Stack',
          comingSoon: false,
          features: ['Everything in Professional +', 'Real-time revenge trading detection (AI)', 'Risk rule alerts (daily loss, position size)', 'Automated weekly report with emotional analysis (AI)', 'Sunday Market Radar — 6–9 high-impact events (AI)', 'Benchmark vs. prop firm requirements', 'Monthly 1-on-1 coaching (30 min)', '24/7 dedicated support'],
      ...
      faqItems: [
        ...
        {
          q: 'What exactly does the Weekly AI Report include?',
          a: "Every Monday morning, Gemini 2.5 analyzes your previous week's trades and delivers a written breakdown covering: your highest-performing hours, emotional states correlated with losses, adherence to your trading plan rules, consistency score status relative to your prop firm, and one specific recommendation for the coming week. It's generated per account — if you trade FTMO and a live account, you get two separate reports.",
        },
        {
          q: 'What is the Market Radar and how is it different from a news alert?',
          a: "The Market Radar is a ZenMode-exclusive email delivered every Sunday evening. ZenTrade's AI uses Google Search to scan global economic and geopolitical events, then builds a curated list of 6–9 high-impact items for the coming week — each tagged with the instrument most affected (NQ, ES, CL, GC) and the expected volatility direction (bullish/bearish/high-volatility). It's not a news feed. It's a prep brief written for a futures trader, not a general investor.",
        },
        {
      ...
      // final CTA section
      ctaSection1: 'Your AI Eval Coach',
      ctaSection2: 'Is Already Waiting',
      ctaSectionSubtitle: "Every week you trade without ZenTrade is a week of patterns your AI could have fixed. The Weekly Report alone has changed how traders approach Monday. Start free — no card, no catch — and find out what your last evaluation couldn't tell you.",
      ctaSectionPoints: [
        'Revenge trading detection active from day one',
        'Weekly AI report every Monday morning',
        'Market Radar every Sunday — 6–9 high-impact events',
        'Works for evaluations and live accounts',
      ],
      ctaTrust1: 'Free 14-Day Trial',
      ctaTrust2: 'No Credit Card',
      ctaTrust3: 'AI Active Immediately',
      // footer
