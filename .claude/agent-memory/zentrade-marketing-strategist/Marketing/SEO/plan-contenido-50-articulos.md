# Plan de Contenido SEO — 50 Artículos Prioritarios
# Zentrade | zen-trader.com
# Actualizado: 2026-03-29

## Criterios de prioridad
- Prioridad 1: Keywords de alto volumen, baja-media dificultad, intención comparativa o transaccional
- Prioridad 2: Keywords educativas de alto volumen relacionadas con prop firms
- Prioridad 3: Keywords de nicho medio que refuerzan autoridad en el tema
- Prioridad 4: Keywords de cola larga que capturan tráfico específico
- Prioridad 5: Keywords de soporte, seasonal o de actualización periódica

## Estado de producción
- GENERADO: artículo existe en data/blog/posts/
- PENDIENTE: en cola de producción

---

## ARTÍCULOS EN ESPAÑOL (30)

| # | Slug | Keyword principal | Intención | Volumen | Dificultad | Prioridad | Categoría | Estado |
|---|------|-------------------|-----------|---------|-----------|-----------|-----------|--------|
| 1 | mejor-journal-trading-futuros-2025 | mejor journal de trading para futuros | Comparativa | Alto | Media | 1 | comparativas | GENERADO |
| 2 | como-pasar-evaluacion-ftmo-journal-trading | cómo pasar evaluación FTMO | Informacional | Alto | Media | 1 | fondeo | GENERADO |
| 3 | zentrade-vs-tradezella | Zentrade vs TradeZella | Comparativa | Alto | Baja | 1 | comparativas | PENDIENTE |
| 4 | que-es-un-trading-journal | qué es un trading journal | Informacional | Alto | Baja | 1 | guias | PENDIENTE |
| 5 | que-es-revenge-trading | qué es el revenge trading | Informacional | Alto | Baja | 1 | psicologia | PENDIENTE |
| 6 | como-pasar-apex-trader-funding | cómo pasar Apex Trader Funding | Informacional | Alto | Media | 1 | fondeo | PENDIENTE |
...
| 18 | como-pasar-tradoverse-evaluacion | cómo pasar Tradoverse | Informacional | Bajo | Baja | 3 | fondeo | PENDIENTE |
| 19 | equity-curve-trading-como-analizar | equity curve trading | Informacional | Medio | Baja | 3 | estrategias | PENDIENTE |
...
| 27 | mejores-instrumentos-futuros-fondeo | mejores futuros para prop firms | Informacional | Bajo | Baja | 4 | estrategias | PENDIENTE |
| 28 | zentrade-vs-tradersync | Zentrade vs TraderSync | Comparativa | Bajo | Baja | 4 | comparativas | PENDIENTE |
| 29 | trading-plan-para-fondeo | trading plan para prop firms | Informacional | Medio | Media | 4 | estrategias | PENDIENTE |
| 30 | reporte-semanal-trading-como-hacerlo | reporte semanal de trading | Informacional | Bajo | Baja | 4 | estrategias | PENDIENTE |

---

## ARTÍCULOS EN INGLÉS (20)

| # | Slug | Keyword principal | Intención | Volumen | Dificultad | Prioridad | Categoría | Estado |
|---|------|-------------------|-----------|---------|-----------|-----------|-----------|--------|
| 31 | best-trading-journal-fondeo-2025 | best trading journal for prop firms | Comparativa | Alto | Alta | 1 | comparativas | GENERADO |
| 32 | how-to-pass-ftmo-evaluation-trading-journal | how to pass FTMO evaluation | Informacional | Alto | Media | 1 | fondeo | PENDIENTE |
| 33 | zentrade-vs-tradezella-comparison | Zentrade vs TradeZella | Comparativa | Alto | Baja | 1 | comparativas | PENDIENTE |
| 34 | what-is-a-trading-journal | what is a trading journal | Informacional | Alto | Media | 1 | guias | PENDIENTE |
| 35 | how-to-pass-apex-trader-funding | how to pass Apex Trader Funding | Informacional | Alto | Media | 1 | fondeo | PENDIENTE |
| 36 | consistency-rule-fondeo-explained | consistency rule prop firm | Informacional | Alto | Baja | 1 | fondeo | PENDIENTE |
...
- Los JSONs van en: data/blog/posts/[slug].json
- relatedSlugs deben apuntar solo a slugs que ya existen en producción
